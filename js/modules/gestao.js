...
const GestaoModule = {
        ...
        UI.openModal({
            ...
            formHtml: `
                <div class="form-group">
                    ...
                    <input type="text" id="l-nome" class="form-control" value="${item ? item.nome : ''}">
                </div>
            `,
            onSave: () => {
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ${users.map(u => {
                                ...
                                // Can only edit if current weight >= target weight
                                const canEdit = currentWeight >= targetWeight;
    ...
    openUserModal(id = null) {
        ...
        const allGroups = ['ADM', 'Supervisor', 'Operador'];
